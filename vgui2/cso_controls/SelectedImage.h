...
class SelectedImage : public vgui::Panel
{
	DECLARE_CLASS_SIMPLE(SelectedImage, Panel);

public:
	SelectedImage(vgui::Panel *parent, const char *panelName) :
	...
	virtual void ApplySchemeSettings(vgui::IScheme *pScheme) override
	{
		...
		m_pTopBackground[0] = vgui::scheme()->GetImage("resource/control/selected/selected_top_left", true);
		m_pTopBackground[1] = vgui::scheme()->GetImage("resource/control/selected/selected_top_center", true);
		m_pTopBackground[2] = vgui::scheme()->GetImage("resource/control/selected/selected_top_right", true);
		m_pCenterBackground[0] = vgui::scheme()->GetImage("resource/control/selected/selected_center_left", true);
		m_pCenterBackground[1] = vgui::scheme()->GetImage("resource/control/selected/selected_center_center", true);
		m_pCenterBackground[2] = vgui::scheme()->GetImage("resource/control/selected/selected_center_right", true);
		m_pBottomBackground[0] = vgui::scheme()->GetImage("resource/control/selected/selected_bottom_left", true);
		m_pBottomBackground[1] = vgui::scheme()->GetImage("resource/control/selected/selected_bottom_center", true);
		m_pBottomBackground[2] = vgui::scheme()->GetImage("resource/control/selected/selected_bottom_Right", true);
...
protected:
	...
	vgui::IImage *m_pTopBackground[3];
	vgui::IImage *m_pCenterBackground[3];
	vgui::IImage *m_pBottomBackground[3];
};
